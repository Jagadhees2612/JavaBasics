class  Z11
{
	public static void main(String[] args) 
	{
		...
		for(int i =1; i <= 5; i++)
		{//loop is executing without any body:so i value is 5 in line 7 
