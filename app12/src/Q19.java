...
class Q19
{
	public static void main(String[] args)
	{
		if(args.length<1 || args[0].length() !=3)
		{
		System.out.println("pls supply 1 cla with 3 digits");
		return;
		}
...
{
	System.out.println(num+ ":containing");
	System.out.println("it is containing sum of first two digits");
}
else
	{
	System.out.println(num+": not containing");
	}
	}
}
